...
| Pane | File | Purpose |
|---|---|---|
| Left sidebar | `docs/NAVIGATION.base` | Browse features, phases, and issues |
...
### How it works
- `NAVIGATION.base` shows tabbed views (Features, Phases, Issues) for navigation
...
### Workspace setup
1. Open `docs/NAVIGATION.base` and drag it to the **left sidebar**
