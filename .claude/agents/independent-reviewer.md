...
3. Record `reviewed_by: model:claude-opus-5`, `review_date: <today>`, the round and the verdict as the skill says, and put the claims table in the feature note's `## Review` section.
